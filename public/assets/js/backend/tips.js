define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'tips/index' + location.search,
                    add_url: 'tips/add',
                    edit_url: 'tips/edit',
                    del_url: 'tips/del',
                    multi_url: 'tips/multi',
                    import_url: 'tips/import',
                    table: 'tips',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'mode', title: __('Mode'), searchList: {"0":__('Mode 0'),"1":__('Mode 1'),"2":__('Mode 2')}, formatter: Table.api.formatter.normal},
