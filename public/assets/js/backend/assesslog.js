define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'assesslog/index' + location.search,
                    add_url: 'assesslog/add',
                    edit_url: 'assesslog/edit',
                    del_url: 'assesslog/del',
                    multi_url: 'assesslog/multi',
                    import_url: 'assesslog/import',
                    table: 'assesslog',
                }
            });
