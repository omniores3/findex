define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'searchlogs/index' + location.search,
                    add_url: 'searchlogs/add',
                    edit_url: 'searchlogs/edit',
                    del_url: 'searchlogs/del',
                    multi_url: 'searchlogs/multi',
                    import_url: 'searchlogs/import',
                    table: 'searchlogs',
                }
            });
